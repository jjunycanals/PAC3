...
bindEditTodo(handler, function (id, text) { return void ; });
void {
    this: .todoList.addEventListener("focusout", function (event) {
        var _a;
        if (_this._temporaryTodoText) {
            var id = event.taget instanceof HTMLElement ? (_a = event.target.parentElement) === null || _a === void 0 ? void 0 : _a.id : null;
            handler(id, _this._temporaryTodoText);
            _this._temporaryTodoText = "";
        }
    })
};
bindToggleTodo(handler, function (id) { return void ; });
void {
